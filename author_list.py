...
{'name': 'J.~Cooke', 'affiliations': ["Centre for Astrophysics and Supercomputing, Swinburne University of Technology, Hawthorn, Victoria 3122, Australia ARC Centre of Excellence for Gravitational Wave Discovery {\it (OzGrav)}"], 'email': 'jeffreycooke@swin.edu.au'},
...
{'name': 'S.~Karpovz', 'affiliations': ["CEICO, Institute of Physics of the Czech Academy of Sciences, Na Slovance 1999/2, CZ-182 21, Praha, Czech Republic"]},
...
{'name': 'M.~Lamoureux', 'affiliations': ['Centre for Cosmology, Particle Physics and Phenomenology - CP3, Universite Catholique de Louvain, B-1348 Louvain-la-Neuve, Belgium'], 'email': 'mathieu.lamoureux@uclouvain.be', 'orcid': '0000-0002-8860-58260000-0002-8860-5826'},
...
{'name': 'A.~M{\"o}ller', 'affiliations': ["Centre for Astrophysics and Supercomputing, Swinburne University of Technology, Hawthorn, Victoria 3122, Australia ARC Centre of Excellence for Gravitational Wave Discovery {\it (OzGrav)}"], 'email': 'amoller@swin.edu.au','orcid':'0000-0001-8211-8608'},
...
{'name': 'A.~Shokry', 'affiliations': ['National Research Institute of Astronomy and Geophysics (NRIAG), 1 El-marsad St., 11421 Helwan, Cairo, Egypt'], 'email' : 'ahmedsh2911@gmail.com'},
